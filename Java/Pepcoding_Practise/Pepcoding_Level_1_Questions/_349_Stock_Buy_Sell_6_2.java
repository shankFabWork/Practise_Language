...
public class _349_Stock_Buy_Sell_6_2 {
	public static void main(String []args)
	{
		...
		int k = scn.nextInt();
		Buy_And_Sell_Stocks_two_Transactions_Allowed(arr,n);
	}

	public static void Buy_And_Sell_Stocks_two_Transactions_Allowed(int arr[],int n)
	{
		int k = 2;
		// r -> day
		// c -> transaction
