// Simple Prims's Algorithm Numericals

// suppose we have ::
// 1) vertices as Computers
// 2) Edges as Wires

// we need to connect Computers in 
// such a way that the wire length in connecting
// Computers should be less
